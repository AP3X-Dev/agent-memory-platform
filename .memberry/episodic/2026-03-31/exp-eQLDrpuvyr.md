...
task: [20260331-latency-reduction] experiment #3: SOP engine was sending full reference docs (global_rules, booking_methods, job_types, must_book_jobs) on every call — 33K chars of static context per call. At 16 calls/min = 132K tokens/min. Now first call includes full context (20K), subsequent calls only SOP + CIC (10K). Result: 41K tokens/min (70% reduction). Also dropped booking_methods and job_types entirely from SOP prompts — rarely needed for real-time alerts.
outcome: approved
created_at: "2026-03-31T20:15:50.653Z"
---
